(function (global, factory) {
   typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@annotorious/annotorious'), require('@annotorious/annotorious/annotorious.css')) :
   typeof define === 'function' && define.amd ? define(['@annotorious/annotorious', '@annotorious/annotorious/annotorious.css'], factory) :
   (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.NotesMaker = factory(global.annotorious));
})(this, (function (annotorious) { 'use strict';
  ...
  <div class="offcanvas offcanvas-end w-100 border-0" tabindex="-1" id="${id}">
      ...
      <div class="offcanvas-body p-0 position-relative"> 
         ...
         el.addEventListener("shown.bs.offcanvas", () => {
           this.anno = annotorious.createImageAnnotator("anno-target-img");
